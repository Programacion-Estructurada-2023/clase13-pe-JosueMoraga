...
namespace MyApp// Note: actual namespace depends on the project name.
{
    internal class Program
    {
         static void Main(string[] args)
        {
           ...
           int minimo = numeros[0]; //Inicializar con valor del indice
           ...
           foreach (int numero1 in numeros)
           {
             ...
             if (numero1 < minimo)
             {
                minimo= numero1; //Actualizar el valor de minimo
             }
           ...
           //1 NUMERO VALDRIA 24 MINIMO 24  Comparamos minimo es = 24
